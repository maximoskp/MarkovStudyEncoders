...
from models import SE_no_pos # DualEncoderModel
import torch
...
def main():
    ...
    # save results
    os.makedirs('results/SE_np/', exist_ok=True)
    results_path = 'results/SE_np/' + subfolder + '.csv'

    os.makedirs('saved_models/SE_np/', exist_ok=True)
    save_dir = 'saved_models/SE_np/'
