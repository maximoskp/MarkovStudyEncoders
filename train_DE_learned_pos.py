...
from models import DE_learned_pos
import torch
...
def main():
    ...
    # save results
    os.makedirs('results/DE_lp/', exist_ok=True)
    results_path = 'results/DE_lp/' + subfolder + '.csv'

    os.makedirs('saved_models/DE_lp/', exist_ok=True)
    save_dir = 'saved_models/DE_lp/'
