...
from models import DE_no_cross
import torch
...
def main():
    ...
    # save results
    os.makedirs('results/DE_nc/', exist_ok=True)
    results_path = 'results/DE_nc/' + subfolder + '.csv'

    os.makedirs('saved_models/DE_nc/', exist_ok=True)
    save_dir = 'saved_models/DE_nc/'
