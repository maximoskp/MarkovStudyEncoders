...
from models import SE_learned_pos # DualEncoderModel
import torch
...
def main():
    ...
    # save results
    os.makedirs('results/SE_lp/', exist_ok=True)
    results_path = 'results/SE_lp/' + subfolder + '.csv'

    os.makedirs('saved_models/SE_lp/', exist_ok=True)
    save_dir = 'saved_models/SE_lp/'
